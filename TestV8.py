...
class TestV8(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "TestV8")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/media/storage/Documents/3rd Year College/RJOVER/Data/test1.txt', False, 0, 0)
...
def main(top_block_cls=TestV8, options=None):
