...
class TestV7(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "TestV7")
        ...
        self.blocks_wavfile_source_1 = blocks.wavfile_source('/home/test2222_imag.wav', False)
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/test2222_real.wav', False)
        ...
        self.connect((self.blocks_wavfile_source_1, 0), (self.blocks_multiply_xx_0, 1))
...
def main(top_block_cls=TestV7, options=None):
