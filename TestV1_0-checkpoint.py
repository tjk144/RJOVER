...
class TestV1_0(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "TestV1_0")
        ...
        self.rtlsdr_source_0.set_center_freq(samp_rate*2, 0)
        ...
        self.rtlsdr_source_0.set_bandwidth(10e6, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_pass_filter_0.set_taps(firdes.band_pass(10, self.samp_rate, 110e6, 130e6, 20e6, firdes.WIN_HAMMING, 6.76))
        self.qtgui_freq_sink_x_0.set_frequency_range(0, self.samp_rate)
        self.rtlsdr_source_0.set_sample_rate(self.samp_rate)
        self.rtlsdr_source_0.set_center_freq(self.samp_rate*2, 0)





def main(top_block_cls=TestV1_0, options=None):
