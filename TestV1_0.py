...
class TestV1_0(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._tuning_range = Range(87.9e6, 108.1e6, 100e3, 108e6, 200)
        ...
        self.blocks_wavfile_sink_0 = blocks.wavfile_sink('/media/storage/Documents/3rd Year College/SeniorProj2/RadioTest.wav', 1, 48000, 8)
