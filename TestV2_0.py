...
class TestV2_0(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "TestV2_0")
        ...
        self._tuning_range = Range(0.5e6, 30e6, 10e3, 0.88e6, 200)
    ...
    def set_tuning(self, tuning):
        self.tuning = tuning
        self.qtgui_freq_sink_x_0.set_frequency_range(self.tuning, 20e3)
...
def main(top_block_cls=TestV2_0, options=None):
